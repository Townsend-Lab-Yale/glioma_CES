...
TP53_plot <- effect_plotter_function("TP53")
# EGFR ----- 
...
EGFR_plot <- effect_plotter_function("EGFR")
...
PTEN_plot <- effect_plotter_function("PTEN")
...
IDH1 <- effect_plotter_function("IDH1")

# ATRX ---- 

ATRX <- effect_plotter_function("ATRX")
...
PIK3R1 <- effect_plotter_function("PIK3R1")

IDH2 <- effect_plotter_function("IDH2")

NF1 <- effect_plotter_function("NF1")

PTPN11 <- effect_plotter_function("PTPN11")

TRAT1 <- effect_plotter_function("TRAT1")
...
H3F3A <- effect_plotter_function("H3F3A")

KIF2B <- effect_plotter_function("KIF2B")

PDGFRA <- effect_plotter_function("PDGFRA")

RB1 <- effect_plotter_function("RB1")

SPATA31D1 <- effect_plotter_function("SPATA31D1")

STAG2 <- effect_plotter_function("STAG2")
