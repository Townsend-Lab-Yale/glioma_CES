...
IDH2 <- IDH2 + 
  geom_text(data = plot_text_annot[1,],aes(x=.255,label="IDH2",fontface="bold"),
            size=annotation_text_size,hjust=0) +
  theme(strip.text.y = element_blank())
...
PTPN11 <- PTPN11 + 
  geom_text(data = plot_text_annot[1,],aes(x=.255,y=4,label="PTPN11",fontface="bold"),
            size=annotation_text_size,hjust=0) +
  theme(strip.text.y = element_blank())
...
TRAT1 <- TRAT1 + 
  geom_text(data = plot_text_annot[1,],aes(x=.255,y=4.55,label="TRAT1",fontface="bold"),
            size=annotation_text_size,hjust=0) +
  theme(strip.text.y = element_blank())
