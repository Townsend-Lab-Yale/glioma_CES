...
ATRX <- effect_plotter_function("ATRX",plot_y_axis_breaks = c(3,4),plot_y_axis_labels = c("3.0","4.0"))
...
# PIK3R1 -----
PIK3R1 <- effect_plotter_function("PIK3R1",x_axis_text = T,
                                  plot_y_axis_breaks = c(4,4.5),plot_y_axis_labels = c("4.0","4.5"))
...
# IDH2 ----
IDH2 <- effect_plotter_function("IDH2",strip_text = T,
...
# TRAT1 ----
TRAT1 <- effect_plotter_function("TRAT1",plot_y_axis_breaks = c(3,4),plot_y_axis_labels = c("3.0","4.0"),plot_y_limits = c(2.9,4.75))
...
cowplot::save_plot(plot = a_r_lab,filename = "figures/Fig_2_a_r.png",base_height = 12,base_width = 20)
...
sig_w_for_stats <- signature_weights %>%
  # filter(group_avg_blended == F) %>%
  filter(sig_extraction_snvs > 35) %>%
...
wilcox.test(SBS42 ~ m_f, data= sig_w_for_stats,alternative="less")
wilcox.test(SBS42 ~ m_f, data= sig_w_for_stats,alternative="two.sided")
t.test(SBS42 ~ m_f, data= sig_w_for_stats,alternative="less")
